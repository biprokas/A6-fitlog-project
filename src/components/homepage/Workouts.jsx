  ...
  return (
    <section className="container mx-auto my-10 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {setsData.slice(0, 12).map((item) => (
          <div
            key={item.id}
            className="bg-[#121418] border border-zinc-800/80 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between hover:border-zinc-700 transition-all duration-300"
          >
            {/* Card Header & Image */}
            <div>
