...
const WorkoutCard = ({item}) => {
  return (
    <Link href= {`/workouts/${item.id}`} ><div className="bg-[#121418] border border-zinc-800/80 rounded-2xl overflow-hidden shadow-xl flex flex-col justify-between hover:border-zinc-700 transition-all duration-300">
      {/* Header */}
      <div>
        ...
        <div className="p-5">
          ...
          <p className="text-zinc-400 text-sm font-medium">{item.equipment}</p>
        </div>
      </div>
